...
const CameraButtons = ({
  ...
  return (
    <View style={styles.camera_buttons}>
      <View accessible={true} accessibilityLabel="Velg bilde fra galleri">
        <Pressable
          onPress={() => {
      ...
      <View accessible={true} accessibilityLabel="Ta nytt bilde">
        <Pressable
          onPress={() => {
      ...
      <View style={styles.button_balancer}></View>
    </View>
  );
};
