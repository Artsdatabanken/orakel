  ...
  return (
    <ScrollView style={[styles.content]}>
      ...
      <Text style={[styles.text, theme.styles.content]}>
        ...
        <Text
          style={[styles.link, theme.styles.link]}
          onPress={() => Linking.openURL("https://artsdatabanken.no")}
        >
          {" "}
        ...
        <Text
          style={[styles.link, theme.styles.link]}
          onPress={() => Linking.openURL("mailto:support@artsobservasjoner.no")}
        >
